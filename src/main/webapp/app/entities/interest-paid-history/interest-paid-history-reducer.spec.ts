...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './interest-paid-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERESTPAIDHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTERESTPAIDHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTERESTPAIDHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTERESTPAIDHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTERESTPAIDHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTERESTPAIDHISTORY actions', async () => {
      const expectedActions = [
        {
