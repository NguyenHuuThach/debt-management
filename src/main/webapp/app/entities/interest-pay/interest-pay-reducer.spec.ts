...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERESTPAY_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTERESTPAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTERESTPAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTERESTPAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTERESTPAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTERESTPAY actions', async () => {
      const expectedActions = [
        {
