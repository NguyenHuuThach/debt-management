...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTHISTORY actions', async () => {
      const expectedActions = [
        {
