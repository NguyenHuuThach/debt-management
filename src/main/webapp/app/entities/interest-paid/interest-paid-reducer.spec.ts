...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERESTPAID_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTERESTPAID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTERESTPAID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTERESTPAID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTERESTPAID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTERESTPAID actions', async () => {
      const expectedActions = [
        {
