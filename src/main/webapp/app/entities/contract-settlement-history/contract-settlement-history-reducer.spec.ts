...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './contract-settlement-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTSETTLEMENTHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACTSETTLEMENTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTSETTLEMENTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTSETTLEMENTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTSETTLEMENTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTSETTLEMENTHISTORY actions', async () => {
      const expectedActions = [
        {
