...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './pay-down-principal-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYDOWNPRINCIPALHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYDOWNPRINCIPALHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYDOWNPRINCIPALHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYDOWNPRINCIPALHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYDOWNPRINCIPALHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYDOWNPRINCIPALHISTORY actions', async () => {
      const expectedActions = [
        {
