...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './contract-settlement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTSETTLEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACTSETTLEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTSETTLEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTSETTLEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTSETTLEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTSETTLEMENT actions', async () => {
      const expectedActions = [
        {
