...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './pay-down-principal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYDOWNPRINCIPAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYDOWNPRINCIPAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYDOWNPRINCIPAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYDOWNPRINCIPAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYDOWNPRINCIPAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYDOWNPRINCIPAL actions', async () => {
      const expectedActions = [
        {
